...
public class PRDTermination {
    ...
    @XmlElements({
        @XmlElement(name = "PRD-by-second", type = engine.schema.generated.PRDBySecond.class),
        @XmlElement(name = "PRD-by-ticks", type = engine.schema.generated.PRDByTicks.class)
    })
